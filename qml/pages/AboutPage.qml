...
Page {
    ...
    SilicaFlickable {
        ...
        Column {
            ...
            Image {
                id: logo
                source: "/usr/share/icons/hicolor/512x512/apps/harbour-aenigma.png"
                smooth: true
                height: width
            ...
            Label {
                ...
                //% "Aenigma is a Sudoku puzzle game for Sailfish OS."
            ...
            BackgroundItem{
                ...
                Row{
                    ...
                    Label{
                        ...
                        text: "https://weblate.nubecula.org/projects/harbour-aenigma"
                        color: parent.parent.pressed ? Theme.highlightColor : Theme.primaryColor

                    }
                }
                onClicked: Qt.openUrlExternally("https://weblate.nubecula.org/engage/harbour-aenigma")
            }
            ...
            Image {
                ...
                smooth: true
                fillMode: Image.PreserveAspectFit
                source: "http://weblate.nubecula.org/widgets/harbour-aenigma/-/harbour-aenigma/multi-auto.svg"
            }
            ...
            BackgroundItem{
                ...
                Row{
                    ...
                    Label{
                        ...
                        text: "https://github.com/black-sheep-dev/harbour-aenigma"
                        color: parent.parent.pressed ? Theme.highlightColor : Theme.primaryColor

                    }
                }
                onClicked: Qt.openUrlExternally("https://github.com/black-sheep-dev/harbour-aenigma")
            }
